void
setup_anton_mapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id){
    MappingScope();
    ...
    Bind(keyboard_macro_start_recording , KeyCode_Period, KeyCode_Control);
    Bind(keyboard_macro_finish_recording, KeyCode_Period, KeyCode_Control, KeyCode_Shift);
    ...
    Bind(change_to_build_panel,         KeyCode_Comma, KeyCode_Alt, KeyCode_Shift);
    Bind(close_build_panel,             KeyCode_Comma, KeyCode_Alt);
    Bind(goto_next_jump,                KeyCode_N, KeyCode_Alt);
    Bind(goto_prev_jump,                KeyCode_N, KeyCode_Alt, KeyCode_Shift);
    Bind(build_in_build_panel,          KeyCode_M, KeyCode_Alt);
    Bind(goto_first_jump,               KeyCode_M, KeyCode_Alt, KeyCode_Shift);
    Bind(toggle_filebar,                KeyCode_F11, KeyCode_Alt);
    ...
    Bind(move_left_whitespace_boundary,    KeyCode_Left, KeyCode_Control, KeyCode_Shift);
    Bind(move_right_whitespace_boundary,   KeyCode_Right, KeyCode_Control, KeyCode_Shift);
    ...
    Bind(replace_in_range,            KeyCode_L, KeyCode_Alt);
    ...
    Bind(list_all_substring_locations_case_insensitive, KeyCode_F, KeyCode_Alt, KeyCode_Shift);
    ...
    Bind(query_replace,               KeyCode_P, KeyCode_Control);
    Bind(query_replace_identifier,    KeyCode_P, KeyCode_Control, KeyCode_Shift);
    Bind(query_replace_selection,     KeyCode_P, KeyCode_Alt);
    ...
    Bind(open_long_braces_semicolon, KeyCode_3, KeyCode_Control);
    Bind(open_long_braces,           KeyCode_Q, KeyCode_Control);
    //Bind(open_long_braces_break,     KeyCode_RightBracket, KeyCode_Control, KeyCode_Shift);
    Bind(select_surrounding_scope,   KeyCode_8, KeyCode_Alt);
    Bind(select_surrounding_scope_maximal, KeyCode_8, KeyCode_Alt, KeyCode_Shift);
    Bind(select_prev_scope_absolute, KeyCode_7, KeyCode_Alt);
    Bind(select_prev_top_most_scope, KeyCode_7, KeyCode_Alt, KeyCode_Shift);
    Bind(select_next_scope_absolute, KeyCode_0, KeyCode_Alt);
    Bind(select_next_scope_after_current, KeyCode_0, KeyCode_Alt, KeyCode_Shift);
